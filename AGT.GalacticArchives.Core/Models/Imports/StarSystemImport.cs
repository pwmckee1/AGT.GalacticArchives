...
public class StarSystemImport : IGoogleSheetImport
{
    ...
    public string? IsGiantSystem { get; set; }
    ...
    public string? IsDissonant { get; set; }
    ...
    public string? NumberOfPlanets { get; set; }

    [Name(StarSystemSheetFields.NumberOfMoons)]
    public string? NumberOfMoons { get; set; }
    ...
    public string? LightYearsFromCenterAutoEstimate { get; set; }
    ...
    public string? XCoordDec { get; set; }

    [Name(StarSystemSheetFields.YCoordDec)]
    public string? YCoordDec { get; set; }

    [Name(StarSystemSheetFields.ZCoordDec)]
    public string? ZCoordDec { get; set; }

    [Name(StarSystemSheetFields.Hex2DecSystemId)]
    public string? Hex2DecSystemId { get; set; }
    ...
    public string? IsPhantomSystem { get; set; }
