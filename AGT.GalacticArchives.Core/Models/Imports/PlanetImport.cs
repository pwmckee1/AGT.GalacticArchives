...
public class PlanetImport : IGoogleSheetImport
{
    ...
    [Name(PlanetSheetFields.RawIngredients1)]
    public string? RawIngredients1 { get; set; }

    [Name(PlanetSheetFields.RawIngredients2)]
    public string? RawIngredients2 { get; set; }

    [Name(PlanetSheetFields.RawIngredients3)]
    public string? RawIngredients3 { get; set; }

    [Name(PlanetSheetFields.RawIngredients4)]
    public string? RawIngredients4 { get; set; }
