...
public enum StarSystemSuitUpgradeTypes
{
    ...
    [Display(ResourceType = typeof(StarSystemResource), Description = nameof(StarSystemResource.RadiationProtectionModule))]
    RadiationProtectionModule,
    [Display(ResourceType = typeof(StarSystemResource), Description = nameof(StarSystemResource.ThermalProtectionModuleCold))]
    ThermalProtectionModuleCold,
    [Display(ResourceType = typeof(StarSystemResource), Description = nameof(StarSystemResource.ThermalProtectionModuleHeat))]
    ...
    [Display(ResourceType = typeof(StarSystemResource), Description = nameof(StarSystemResource.UnderwaterProtectionModule))]
