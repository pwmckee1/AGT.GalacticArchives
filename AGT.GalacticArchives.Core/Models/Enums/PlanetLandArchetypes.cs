...
{
    [Display(ResourceType = typeof(LandArchetypesResource), Description = nameof(LandArchetypesResource.ChasmsMountains))]
    ChasmsMountains = 1,
    ...
    [Display(ResourceType = typeof(LandArchetypesResource), Description = nameof(LandArchetypesResource.PeaksMountains))]
    PeaksMountains,

    [Display(ResourceType = typeof(LandArchetypesResource), Description = nameof(LandArchetypesResource.RockPillars))]
    RockPillars,

    [Display(ResourceType = typeof(LandArchetypesResource), Description = nameof(LandArchetypesResource.RollingHillsMountains))]
    RollingHillsMountains,

    [Display(ResourceType = typeof(LandArchetypesResource), Description = nameof(LandArchetypesResource.RollingMountainsMountains))]
    RollingMountainsMountains,

    [Display(ResourceType = typeof(LandArchetypesResource), Description = nameof(LandArchetypesResource.RuggedMountainsMountains))]
    ...
    [Display(ResourceType = typeof(LandArchetypesResource), Description = nameof(LandArchetypesResource.TallMountainsMountains))]
