...
public class Region : IDatabaseGameEntity
{
    ...
    public string XX => !string.IsNullOrEmpty(GalacticCoordinates) ? GalacticCoordinates.Split(':')[0] : string.Empty;

    public string YY => !string.IsNullOrEmpty(GalacticCoordinates) ? GalacticCoordinates.Split(':')[1] : string.Empty;

    public string ZZ => !string.IsNullOrEmpty(GalacticCoordinates) ? GalacticCoordinates.Split(':')[2] : string.Empty;
