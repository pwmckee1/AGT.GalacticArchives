...
public static class StarSystemSheetFields
{
    ...
    public const string GlyphHexCode = "Glyph Code";
    ...
    public const string SSHex = "Sysnum";
    public const string StarSystemAge = "System Age (billions of years)";
    ...
    public const string XXDec = "X coord DEC";
    public const string YYDec = "Y coord DEC";
    public const string ZZDec = "Z coord DEC";
