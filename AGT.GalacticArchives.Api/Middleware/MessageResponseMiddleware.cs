...
namespace AGT.GalacticArchives.Middleware;
    ...
    {
        private static readonly HashSet<string> _validContentTypes = new HashSet<string>
        {
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            var contentType = context.Response.ContentType?.ToLower().Split(';', StringSplitOptions.RemoveEmptyEntries).FirstOrDefault();
                ...
                && (context.Request.Path.Value != null && !context.Request.Path.Value.Contains("swagger")))
            {
                ...
                var contentBody = JsonConvert.DeserializeObject(responseBody)!;
