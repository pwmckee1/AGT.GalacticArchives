...
public class ServiceModule : Module
{
    protected override void Load(ContainerBuilder builder)
    {
        ...
        builder.Register((c, _) => new ValidatedSettlementServiceDecorator(
        ...
        builder.Register((c, _) => new ValidatedStarshipServiceDecorator(
